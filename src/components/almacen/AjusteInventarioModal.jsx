...
const AjusteInventarioModal = ({ isOpen, onClose, producto, onAjusteCreated }) => {
  ...
  useEffect(() => {
    if (formData.conteoFisico !== '') {
      ...
      const stockActual = producto?.stock_millares || 0;
          ...
          <form onSubmit={handleSubmit}>
            ...
            {diferencia !== 0 && (
              <div className={`p-3 rounded-lg mb-4 ${
                ...
                <div className={`text-lg font-bold ${
                  ...
                  {diferencia > 0 ? '+' : ''}{diferencia.toLocaleString()} millares
                </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="Ingresa las millares contadas físicamente"
                disabled={loading}
              />
            </div>
            ...
            <div className="mb-6 bg-blue-50 p-4 rounded-lg">
              ...
              <div className="text-xs text-blue-600">
                ...
                • El ajuste será por {Math.abs(diferencia)} millares<br/>
