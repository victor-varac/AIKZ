...
import { getProductosCelofan, getEntregasPendientes, createMovimientoCelofan, updateMovimientoCelofan } from '../../services/api/almacen';

const MovimientoCelofanForm = ({ isOpen, onClose, onMovimientoCreated, productoPreseleccionado, entradaToEdit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (entradaToEdit) {
        ...
        resultado = await updateMovimientoCelofan(entradaToEdit.id, movimientoData);
      } else {
        // Creando nueva entrada
        resultado = await createMovimientoCelofan(movimientoData);
      }
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">
              {entradaToEdit ? '✏️ Editar Entrada de' :
               ...
               '📥 Registrar Movimiento de'} Celofán
            </h2>
...
export default MovimientoCelofanForm;