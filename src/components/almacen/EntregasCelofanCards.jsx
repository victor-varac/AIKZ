...
const EntregasCelofanCards = ({ notasVenta, loading, onEntregarTodo, onRegistrarEntrega, onEditarEntregas }) => {
    ...
    return (
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Entregas de Productos de Celofán</h2>
          <p className="text-sm text-gray-600 mt-1">Notas de venta con productos de celofán pendientes de entrega</p>
        </div>
        <div className="p-6">
      ...
      <div className="p-6">
        {notasVenta.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mt-2">No se encontraron notas de venta con productos de celofán pendientes</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {notasVenta.map((nota) => (
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="text-sm font-medium text-gray-900">
                      Productos de Celofán ({nota.pedidos?.length || 0})
                    </h4>
                    <button
                ...
                <div className="mt-4 space-y-2">
                  ...
                  {(nota.estadisticas?.totalPendiente || 0) > 0 && (
                    <>
                      ...
                      >
                        ✅ Entregar Todo ({(nota.estadisticas?.totalPendiente || 0).toLocaleString()} millares)
                      </button>
                      <button
                  ...
                  {(nota.estadisticas?.totalEntregado || 0) > 0 && (
                    ...
                    >
                      ✏️ Editar Entregas ({(nota.estadisticas?.totalEntregado || 0).toLocaleString()} millares)
                    </button>
                  )}
...
export default EntregasCelofanCards;