...
import { getEntradasCelofanPorProducto, deleteMovimientoCelofan, updateMovimientoCelofan } from '../../services/api/almacen';
import MovimientoCelofanForm from './MovimientoCelofanForm';

const ProductoCelofanDetail = ({ producto, onBack, onMovimientoCreated }) => {
  ...
  const handleDeleteEntrada = async (entradaId) => {
    try {
      await deleteMovimientoCelofan(entradaId);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 mt-1">Millares Totales</div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="text-lg font-medium text-green-600">
                  {(entradasDetalle.estadisticas.ultimaEntrada.millares || 0).toLocaleString()} millares
                </div>
              </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-4 mb-2">
                          ...
                          <div className="text-xl font-bold text-green-600">
                            +{(entrada.millares || 0).toLocaleString()} millares
                          </div>
                        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              ...
              <p className="text-gray-600 mb-6">
                ...
                con {(showDeleteConfirm.millares || 0).toLocaleString()} millares?
              </p>
...
export default ProductoCelofanDetail;