...
const EntradasPolietilenoCards = ({ entradasPorProducto, loading, onNuevaEntrada, onVerDetalle }) => {
  ...
  const productosFiltrados = useMemo(() => {
    ...
    return entradasPorProducto.filter(item => {
      ...
      if (!filtroAncho && !filtroLargo) return true;
  ...
  }, [entradasPorProducto, filtroAncho, filtroLargo]);
    ...
    return (
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Entradas por Producto de Polietileno</h2>
          <p className="text-sm text-gray-600 mt-1">Historial de entradas al almacén organizadas por producto (en kg)</p>
        </div>
        <div className="p-6">
        ...
        {productosFiltrados.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mt-4">
              {(filtroAncho || filtroLargo)
                ? 'No se encontraron productos con esas medidas'
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-600">Kg Totales</div>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <div>
                        ...
                        <div className="font-medium text-green-600">
                          {(item.estadisticas.ultimaEntrada.millares || 0).toLocaleString()} kg
                        </div>
                      </div>
                ...
                <div className="flex justify-between items-center text-sm mb-4">
                  ...
                  <span className="font-medium">
                    {(item.estadisticas?.promedioEntrada || 0).toLocaleString()} kg
                  </span>
                </div>
...
export default EntradasPolietilenoCards;