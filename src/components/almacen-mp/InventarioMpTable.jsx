...
const InventarioMpTable = ({ inventario, loading }) => {
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">No hay materias primas de celofán registradas en el sistema.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Stock disponible de materias primas de celofán
        </p>
      </div>
...
export default InventarioMpTable;